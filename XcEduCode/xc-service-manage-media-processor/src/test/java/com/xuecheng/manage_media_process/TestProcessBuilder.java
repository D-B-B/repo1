...
//        processBuilder.command("java","-jar","f:/xc-service-manage-course.jar");
    ...
    public void testFFmpeg() throws IOException {
        ...
        command.add("-i");
        command.add("D:\\ffmpeg_test\\lucene.avi");
        ...
        command.add("-r");
        command.add("18");
        command.add("D:\\ffmpeg_test\\1.mp4");
    ...
    public void testMp4VideoUtil(){
        ...
        //video_path视频地址
        String video_path = "D:\\ffmpeg_test\\video\\lucene.avi";
        //mp4_name mp4文件名称
        String mp4_name  ="lucene.mp4";
        //mp4folder_path mp4文件目录路径
        String mp4folder_path="D:\\ffmpeg_test\\video\\";
